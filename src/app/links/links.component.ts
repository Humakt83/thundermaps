...
@Component({
    ...
    styleUrls: ['app/links/links.css']
})
export class LinksComponent {

    links: Link[] = [
        new Link('http://www.celestialheavens.com/', IMAGE_PREFIX + 'celestial_heavens_logo.jpg', 'Celestial Heavens is possibly the best Heroes of Might and Magic site there is. Lot of maps, map reviews, useful files, guides, walkthroughs, fresh news and etc.'),
